    ...
    <div className="flex justify-between items-center ">
      <form className="relative w-9/12 " onSubmit={handleSubmit}>
        ...
        <input
          ...
          className="w-[90%] bg-white py-3 pl-14 pr-5 rounded-xl h-12 border-none focus:border-none focus:ring-0 focus:outline-custom-sky-blue"
        />
      </form>

      {/* notification bell */}
      <div className="relative w-12 h-12 bg-white p-2.5 rounded-full transform -translate-x-9">
      ...
      {/* profile image */}
      <div className="h-16 rounded-xl w-2/8 bg-white py-2.5 px-3 flex gap-3 items-start">
        <img
